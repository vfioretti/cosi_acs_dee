...
for jrun in range(run_start, run_stop + 1):
	...
	if gorun == 1:
		...
		if source == "Am241" or source == "Cs137": am241_or_cs137 = 1
		if source == "Na22": am241_or_cs137 = 0
		l = 0
		for line in list_of_lines:
			...
			if line.startswith('GEOM.COSI.COLLIMATED'):
					list_of_lines[l] = 'GEOM.COSI.COLLIMATED = 0\n'
			if line.startswith('GEOM.COSI.AM241.OR.CS137'):
					list_of_lines[l] = 'GEOM.COSI.AM241.OR.CS137 = '+str(am241_or_cs137)+'\n' 
			if (num_threads > 1):
