...
##################
    ...
    for source in sources:
        ...
        for line in lines:
            ...
            # Get only photopeak events (i.e. events with energy deposit close to the peak energy)
            ...
            responseMin = []
            responseMax = []
            # The maximum response is the maximum of the responses for each positional shift, normalized to the sum of the minimum responses from all shifts
            # The minimum response is the minimum of the responses for each positional shift, normalized to the sum of the maximum responses from all shifts
    ...
    for rs, ers, rl, erl, rmin, rmax, e in zip(relResponseSim, relResponseErrSim, relResponseLab, relResponseErrLab, responseRel_min, responseRel_max, ene):
        ...
        # Apply the same systematic errors to the experiment
        err_sys_lab = (err_sys_tot_sim / rs) * rl
        # Add systematic errors to the experiment
